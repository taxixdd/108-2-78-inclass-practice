...
get_courses <- function(entranceYear, major){
  pick1 <- str_detect(courseStructure$應修系級,"(?<=major)[1]",negate = FALSE)
  pick2 <- str_detect(courseStructure$應修系級,"(?<=major)[2]",negate = FALSE)
  pick3 <- str_detect(courseStructure$應修系級,"(?<=major)[3]",negate = FALSE)
  pick4 <- str_detect(courseStructure$應修系級,"(?<=major)[4]",negate = FALSE)
